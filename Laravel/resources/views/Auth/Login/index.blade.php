	...
	<div id="main" role="main">
		...
		<div id="content" class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-offset-4 col-lg-offset-4 col-md-5 col-lg-4">
					<div class="well no-padding">
						<form action="{{ route('user.authenticate') }}" enctype="multipart/form-data" method="POST" id="login-form" class="smart-form client-form">
							@csrf
							<header>
								Sign In
							</header>
