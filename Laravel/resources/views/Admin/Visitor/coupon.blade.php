    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <select style="width:100%" id="NetworkId" name="NetworkId" class="select2">
                ...
                <option value="{{ $NetworkId }}">{{ $Name }}</option>
        ...
        <div class="col-md-3">
            <label class="control-label">Exclude IP</label>

            <select multiple style="width:100%" id="IP" name="IP" class="select2">
                @if(isset($ips))
                @foreach ($ips as $ip)
    ...
    var CouponModule = (function() {
            ...
            self.BindCouponTable = function() {
                visitorTable = $('#visitor_table').DataTable({
                    ...
                    "sAjaxSource": "{{ route('admin.visitor.coupon') }}",
                    "fnServerParams": function(aoData) {
                        ...
                        aoData.push({
                            ...
                            "name": "IP",
                            "value": $("#IP").val() == null ? "-1" : $("#IP").val().toString()
                        }, {
                            "name": "EndDate",
                            "value": endDate
                        });
                            ...
                            "render": function(data, type, row, val) {
                                {
                                    if (row.CreateDate) {
                                        ...
                                        return splited[2] + "/" + splited[1] + "/" + splited[0] + ' ' + row.CreateDate.split(' ')[1];
                                    }
