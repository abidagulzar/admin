					...
					"aoColumns": [{
						...
						},
						{
							...
							"render": function(data, type, row, val) {
								...
								actions += '<a class="green" target="_blank" href="' + editAction + '"  ><i class="fa fa-pencil datatable-Icon"></i></a>  <a class="red" onClick="StoreModule.deleteStoreModal(' + "\'" + row.StoreId + "\'" + "," + "\'" + dataTitle + "\'" + ')"  ><i class="fa fa-trash-o datatable-Icon"></i></a></div>'
