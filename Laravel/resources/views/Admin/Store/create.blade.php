                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input id="storeName" type="text" class="form-control" onchange="onStoreNameChange()" name="Name" value="{{ old('Name') }}" placeholder="Store Name" data-bv-group=".col-md-3" data-bv-notempty="true" data-bv-notempty-message="Information Required" />
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Regional Store Name</label>
                            <input type="text" class="form-control" name="RegionalName" value="{{old('RegionalName')}}" placeholder="Regional Store Name" data-bv-group=".col-md-3" data-bv-notempty="true" data-bv-notempty-message="Information Required" />
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Store Name In Network</label>
                            <input type="text" class="form-control" name="StoreNetworkName" value="{{old('StoreNetworkName')}}" placeholder="Store Name In Network" data-bv-group=".col-md-3" />
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Store Site Url</label>

                            <input type="text" class="form-control" name="SiteUrl" value="{{ old('SiteUrl') }}" placeholder="Store Site Url" data-bv-group=".col-md-3" data-bv-notempty="true" data-bv-notempty-message="Information Required" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select multiple style="width:100%" id="CountryId" name="CountryId[]" class="select2" data-bv-group=".col-md-6" data-bv-notempty="true" data-bv-notempty-message="Information Required">
                                ...
                                <option value="{{ $CountryId }}" {{ (collect(old('CountryId'))->contains($CountryId)) ? 'selected':'' }}>{{ $Name }}</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select data-placeholder="Please Select" style="width:100%" onchange="onStoreNameChange()" id="StoreSettingID" name="StoreSettingID" class="select2" data-bv-group=".col-md-3" data-bv-notempty="true" data-bv-notempty-message="Information Required">
                                ...
                                <option value="{{ $StoreSettingID }}" {{old('StoreSettingID',1)==$StoreSettingID? 'selected':''}}>{{ $Name }}</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select data-placeholder="Please Select" style="width:100%" id="UserAssignedID" name="UserAssignedID" class="select2" data-bv-group=".col-md-3">
                                ...
                                <option value="{{ $id }}" {{old('UserAssignedID')==$id? 'selected':''}}>{{ $name }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select multiple style="width:100%" id="ExcludeCountryId" name="ExcludeCountryId[]" class="select2" data-bv-group=".col-md-6">
                                ...
                                <option value="{{ $CountryId }}" {{ (collect(old('ExcludeCountryId'))->contains($CountryId)) ? 'selected':'' }}>{{ $Name }}</option>
                        ...
                        <div class="col-md-2">
                            ...
                            <select data-placeholder="Please Select" style="width:100%" id="RevenueModelID" name="RevenueModelID" class="select2" data-bv-group=".col-md-2" data-bv-notempty="true" data-bv-notempty-message="Information Required">
                                ...
                                <option value="{{ $RevenueModelID }}" {{old('RevenueModelID', '1')==$RevenueModelID? 'selected':''}}>{{ $Name }}</option>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="StoreUpdateFrequency" value="{{ old('StoreUpdateFrequency', '30') }}" placeholder="Update Frequency (Days)" data-bv-group=".col-md-2" data-bv-notempty="true" data-bv-notempty-message="Information Required" />

                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Merchant ID</label>

                            <input type="number" class="form-control" name="MerchantID" value="{{ old('MerchantID', '') }}" placeholder="Merchant ID" data-bv-group=".col-md-2" />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div>
                                ...
                                <label class="checkbox-inline">
                                    <input id="IsHomeStore" name="IsHomeStore" {{ old('IsHomeStore') == 1 ?  'checked' : '' }} value="1" type="checkbox" class="checkbox style-0">
                                    <span>Home Store (Show at Home)</span>
                                </label>
                                <label class="checkbox-inline ">
                                    <input id="IsShowAdd" {{ old('IsShowAdd') == 1 ?  'checked' : '' }} name="IsShowAdd" value="1" type="checkbox" class="checkbox style-0" />
                                    <span>Show Add</span>
                                </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select data-placeholder="Please Select" style="width:100%" id="NetworkId" name="NetworkId" class="select2" data-bv-group=".col-md-6" data-bv-notempty="true" data-bv-notempty-message="Information Required">
                                ...
                                <option value="{{ $NetworkId }}" {{old('NetworkId', 13)==$NetworkId? 'selected':''}}>{{ $Name }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select multiple style="width:100%" id="SimilarStoreId" name="SimilarStoreId[]" class="select2" data-bv-group=".col-md-6">
                                ...
                                <option value="{{ $StoreId }}" {{ (collect(old('StoreId'))->contains($StoreId)) ? 'selected':'' }}>{{ $RegionalName }}</option>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="Header1" class="form-control" name="Header1" value="{{ old('Header1') }}" placeholder="Header 1" data-bv-group=".col-md-6" />
                        </div>
                        <div class="col-md-6">
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" value="coupon-codes" class="form-control" id="Keyword" name="Keyword" value="{{ old('Keyword') }}" placeholder="Search Name" data-bv-group=".col-md-6" data-bv-notempty="true" data-bv-notempty-message="Information Required" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <label class="control-label">Content Link Text</label>
                            <input type="text" class="form-control" id="ContentLinkText" name="ContentLinkText" value="{{ old('ContentLinkText') }}" placeholder="Content Link Text" data-bv-group=".col-md-6" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control tagsinput" name="MetaKeyword" value="{{ old('MetaKeyword') }}" placeholder="" data-role="tagsinput" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control tagsinput" name="RelatedSearches" value="{{ old('RelatedSearches') }}" data-role="tagsinput">
                        </div>
                    </div>
                </fieldset>
                <br />
...
<script>
    ...
    function onStoreNameChange() {
        var objStoreName = '#storeName';
        var txt = '';

        if ($("#StoreSettingID").val() == "1") { // General
            txt = $(objStoreName).val() + ' Coupon Codes & ' + $(objStoreName).val() + ' Promo Codes';
            $("#Keyword").val("coupon-codes");
        } else if ($("#StoreSettingID").val() == "2") { // Germany
            txt = $(objStoreName).val() + ' Gutscheincode @currentmonthshort @currentyearfull';
            $("#Keyword").val("gutschein");
        } else if ($("#StoreSettingID").val() == "3") { // russia
            txt = $(objStoreName).val() + ' Коды купонов и промокод';
            $("#Keyword").val("promokod");
        }
