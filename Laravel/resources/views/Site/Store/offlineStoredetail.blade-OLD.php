                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="category-product coupons-section coupons-section-inner">
                            <div id="storedeals" class="row coupons-deals">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 wow fadeInUp shufflefilter1" data-groups='["Deal"]'>
                                    <div class="item">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <img class="img-responsive" src="{{ url('/storage/storelogo').'/'.$cpcStore->LogoUrl }}" alt="">
                                                        <div class="brand">{{$cpcStore->SEOStoreName}}</div>
                                                        <h3 class="name"><a data-cpcstoreid="{{$cpcStore->StoreId}}" data-affiliateurl="{{$cpcStore->TrackURL}}" data-url="{{ route('site.cpcPopUrl', ['targetstoreid' => $cpcStore->StoreId,'sourcestoreid' => $store->StoreId]) }}" onclick="onOfflineCopounClick(this)">{{$cpcStore->DealHeader}}</a></h3>
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    <div class="show-code"><a data-cpcstoreid="{{$cpcStore->StoreId}}" data-affiliateurl="{{$cpcStore->TrackURL}}" data-url="{{ route('site.cpcPopUrl', ['targetstoreid' => $cpcStore->StoreId,'sourcestoreid' => $store->StoreId]) }}" onclick="onOfflineCopounClick(this)">{{$storeSetting->GetDeal}}</a></div>
