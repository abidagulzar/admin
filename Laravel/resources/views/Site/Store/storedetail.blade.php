    ...
    <div class='container'>
        ...
        <div class='row'>
            ...
            <div class="col-md-9 rht-col">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        ...
                                                        <h3 class="name"><a data-affiliateurl="{{$storeCoupon->CouponUrl}}" data-url="{{ route('site.couponPopUpUrl', ['store' => $store->SEOStoreName,'couponid' => $storeCoupon->CouponId]) }}" onclick="onCopounClick(this)">{!! str_replace($storeCoupon->Code, '', $storeCoupon->Header) !!}</a></h3>
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        ...
                                                        <h3 class="name"><a data-affiliateurl="{{$storeCoupon->CouponUrl}}" data-url="{{ route('site.couponPopUpUrl', ['store' => $storeCoupon->SEOStoreName,'couponid' => $storeCoupon->CouponId]) }}" onclick="onCopounClick(this)">{{$storeCoupon->Header}}</a></h3>
                                                ...
                                                <div class="product-info text-left">
                                                    <div class="discount"><span>{{$storeCoupon->OFF}}</span></div>
                                                    <div class="show-code"><a data-affiliateurl="{{$storeCoupon->CouponUrl}}" data-url="{{ route('site.couponPopUpUrl', ['store' => $storeCoupon->SEOStoreName,'couponid' => $storeCoupon->CouponId]) }}" onclick="onCopounClick(this)">@if(empty($storeCoupon->Code)){{$storeSetting->GetDeal}} @else {{$storeSetting->ShowCode}} @endif</a></div>
                                                    <p class="exp-date"><i class="fa fa-clock-o"></i> {{empty($storeCoupon->ExpiryDate) ||$storeCoupon->IsUnknownOutGoing == 1 ? $storeSetting->UnknownOutGoing:$storeSetting->ExpiresOn.' '.date('d/m/Y', strtotime($storeCoupon->ExpiryDate)) }}</p>
                                                </div>
                        ...
                        @if(isset($storeSetting->DefaultQA) && $storeSetting->DefaultQA != '')
                        <div class="text-center p-10 panel">
                            <div class=" panel" style="margin-top:10px;font-size:17px;color:black;">
                                <p class="mb-15" style="text-align:justify;">{!! $storeSetting->DefaultQA !!}</p>
                            </div>
                        </div>
                        @endif
                    </div>
            ...
            <div class="col-md-3 sidebar">
                ...
                @if(isset($store->IsShowAdd) && $store->IsShowAdd == 1)
