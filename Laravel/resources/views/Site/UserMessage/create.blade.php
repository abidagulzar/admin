                ...
                <div class="sign-in-page">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 sign-in">
                            <h4 class="">CONTACT INFORMATIONS</h4>
                            <p class="" style="color: #3e3439 !important;">@if(isset($siteInfo)){!! $siteInfo->ContactUs !!}@endif</p>
                        ...
                        <div class="col-md-6 col-sm-6 create-new-account">
                            ...
                            <form class="register-form outer-top-xs" role="form" action="{{ route('site.contactuspost') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="info-title" for="Website">Website </label>
                                    <input type="text" class="form-control unicase-form-control text-input" name="Website" id="Website">
                                </div>
                                <div class="form-group">
                                    <label>Message</label>
                                    <textarea rows="5" class="form-control" name="Message" id="Message" required></textarea>
                                </div>
                                <input id="IsSuggestion" name="IsSuggestion" class="hidden" value="0" />
