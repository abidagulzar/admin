<?php get_header();
    	...
    	<div class="main-container<?php echo esc_attr( $baxel_current_layout ); ?>">
                ...
                if ( have_posts() ) :
                    ...
                    baxel_set_post_views( get_the_ID() );
                                ...
                                while( $related_posts_query->have_posts() ) {
                                    ...
                                    if ( $baxel_counter % $baxel_rpCol == 0 ) {
                                        ...
                                        <div class="clearfix related-posts-row<?php echo esc_attr( $baxel_current_layout ); ?>"><?php
                                            ...
                                            <a class="clearfix related-post-item<?php if ( $baxel_rpCol == 2 ) { echo '-2'; } echo esc_attr( $baxel_current_layout ); ?>" href="<?php echo get_the_permalink(); ?>">
